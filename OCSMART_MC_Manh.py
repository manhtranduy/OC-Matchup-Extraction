...
class OCSMART_MC:
    def __init__(self, L1B_file, 
        ...
        if sinfo.sensor_status == 0:
            ...
            if l1b.geoloc_status == 0:
                ...
                elif lat_center and lon_center and box_width in box_height:
    ...
    #                hf.create_dataset('RH',dtype='float64',data = l1b_rh,compression="gzip", compression_opts=9)
    ...
    #                for i in np.arange(len(sinfo.band)):
